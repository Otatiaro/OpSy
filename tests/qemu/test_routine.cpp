...
opsy::utility::routine driven(opsy::utility::routine_storage<192>&, std::atomic<int>* step)
{
	for (int i = 0; i < step_count; ++i)
	{
		...
		// Just wait: what this case is about is where the routine resumes, not
		// what it reads. Reading a register and discarding it is what
		// suspended's [[nodiscard]] is there to stop.
